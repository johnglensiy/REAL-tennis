...
const initialState: TournamentState[] = [
  {
    ...
    matches: [
      { id: 'main', status: 'live', scheduledDate: '2026-07-04', meta: 'Set 4 · 2:14', live: 'LIVE', href: 'Tennis Scoreboard.html',
  ...
  },
  {
    ...
    matches: [
      { id: 'e1', status: 'live', scheduledDate: '2026-07-04', meta: 'Set 1 · 0:23', live: 'LIVE',
        a: { name: 'B. Müller',   country: 'AUT', seed: '4',  sets: [3], pts: 'Ad', serving: true },
        b: { name: 'O. Traoré',   country: 'CIV', seed: '—',  sets: [2], pts: '40' } },
      { id: 'e2', status: 'upcoming', scheduledDate: '2026-07-04', meta: 'Today · 15:00',
        a: { name: 'G. Rossi',    country: 'ITA', seed: '1' },
        b: { name: 'A. Kovač',    country: 'SRB', seed: '7' } },
      { id: 'e3', status: 'upcoming', scheduledDate: '2026-07-04', meta: 'Today · 18:45',
...
const tournamentsSlice = createSlice({
    ...
    reducers: {
      ...
      matchScheduled(state, action: PayloadAction<MatchScheduled>) {
        ...
        let tournament = state.find(t => t.name === ev.tournament && t.tour === ev.tour);
        if (!tournament) {
          tournament = { name: ev.tournament, tour: ev.tour, detail: '', matches: [] };
